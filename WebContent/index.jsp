...
<div class="product">
    ...
    <div class="floor wt1080" style="border-top:2px solid ${colorstr};">
        ...
        <div class="right">
            <h1>最新热卖</h1>
            <ul>
            <c:forEach items="${fcategory.phlist}" var="ordermsg" begin="0" end="3">
                <li>
                    <dl>
                        <dt><a href="productDetails.do?id=${ordermsg.product.id}"><img src="upload/${ordermsg.product.filename}"></a></dt>
                        <dd class="xiangxi"><a href="productDetails.do?id=${ordermsg.product.id}">${ordermsg.product.productname }</a></dd>
                        <dd>
                        <c:choose>
                          <c:when test="${ordermsg.product.tprice gt 0}">
                          <span class="fl">￥${ordermsg.product.tprice}</span><span class="fr">￥${ordermsg.product.price }</span>
                          </c:when>
                          <c:otherwise>
                          <span class="fl">￥${ordermsg.product.price}</span>
                          </c:otherwise>
                        </c:choose>

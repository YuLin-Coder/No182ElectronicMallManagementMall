      ...
      <table class="table table-striped b-t b-light">
        ...
        <c:forEach items="${pageInfo.list}" var="product" varStatus="status">
          <tr>
            ...
            <td>
              <c:if test="${product.istj eq 'yes'}">
              <a href="udateIstj.do?id=${product.id}&type=no&shop=fd" title="no" class="active" ui-toggle-class=""><i class="fa fa-hand-o-down"></i></a>
              </c:if>
              <c:if test="${product.istj eq 'no'}">
              <a href="udateIstj.do?id=${product.id}&type=yes&shop=fd" title="yes" class="active" ui-toggle-class=""><i class="fa fa-hand-o-up"></i></a>
              </c:if>
              <a href="udateIssj.do?id=${product.id}&shop=fd" title="上下架" class="active" ui-toggle-class=""><i class="fa fa-arrows-v"></i></a>
              <a href="showProduct.do?id=${product.id}" title="编辑" class="active" ui-toggle-class=""><i class="fa fa-edit text-edit text-active"></i></a>

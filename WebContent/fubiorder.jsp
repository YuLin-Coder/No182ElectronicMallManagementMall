        ...
        <div class="c_r_o" style="margin: 0px;padding: 0px;">
            ...
            <table class="ordertable"  bordercolor="#E8E8E8" cellpadding="1" cellspacing="0" >
                <tr class="tableth" >
                    ...
                    <td style="font-size:12px;">积分</td>
                    <td style="font-size:12px;">数量</td>
                    <td style="font-size:12px;">总计</td>
                ...
                <tr class="thitems">
                    ...
                    <span style="float: left;margin-left:10px;"><img src="upload/${ordermsg.ordermsgdetails.product.filename}" style="width: 60px;height: 60px;"/></span>
                    ${ordermsg.ordermsgdetails.product.productname}
                    </td>
                    <td style="width: 90px;font-size:12px;"> ${ordermsg.ordermsgdetails.product.price}</td>
                    <td style="width: 90px;font-size:12px;"> ${ordermsg.ordermsgdetails.num}</td>
                    ...
                    <a href="fubiqianshou.do?id=${ordermsg.id}" style="color: green">签收</a>
                    </c:if>
                    
                    
                    <c:if test="${ordermsg.fkstatus eq '交易完成'}">
                    <a href="fubiorderSc.do?id=${ordermsg.id}" style="color: green">删除</a>
                    </c:if>
